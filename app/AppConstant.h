...
#define		ONESIGNAL_APPID						@"eef87e1f-f2d3-4aa6-b588-2182a5ab89d4"
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define		SINCH_HOST							@"clientapi.sinch.com"
#define		SINCH_KEY							@"785b0da5-9847-4596-802c-d23d5282d749"
#define		SINCH_SECRET						@"unl73lKaO02GGvCopYeTGw=="
//-------------------------------------------------------------------------------------------------------------------------------------------------
#define		DIALOGFLOW_ACCESS_TOKEN				@"b10e17ee525e419e9b0cc97bf5e6c8ddf"
//-------------------------------------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------
#define		TEXT_SHARE_APP						@"Check out Sync Chat"
//-------------------------------------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------
#define		FCALL_PATH							@"Calls"				//	Path name
