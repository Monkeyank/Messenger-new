class MessageRelay: NSObject {
	...
	class func send(dbmessage: DBMessage, completion: @escaping (_ error: Error?) -> Void) {
		...
		if (dbmessage.type == MESSAGE_PICTURE)	{ sendMessageImage(message: message, completion: completion) 	}
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	class func sendMessageImage(message: FObject, completion: @escaping (_ error: Error?) -> Void) {
